...
class modificate_ticket extends Mailable
{
 ...
 public function build()
{
    ...
    return $this->subject("NOTIFICACIÓN DE TICKET")
                ->view('mails.modificate_ticket', compact('user_sender', 'user_destination','ticket'));
}
