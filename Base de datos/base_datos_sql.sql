...
-- -----------------------------------------------------
-- Table `grupo_tdm_db`.`tpv_types`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `grupo_tdm_db`.`tpv_types` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `grupo_tdm_db`.`tpvs` (
  ...
  `id_user` INT NULL,
  `id_shop` INT NULL,
  `id_tpv_component` INT NOT NULL,
  `id_state` INT NOT NULL,
  `updated_at` TIMESTAMP NULL,
  `created_at` TIMESTAMP NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_tpvs_states1_idx` (`id_state` ASC),
  INDEX `fk_tpvs_tpv_types1_idx` (`id_tpv_component` ASC),
  INDEX `fk_tpvs_users2_idx` (`id_user` ASC),
  ...
  CONSTRAINT `fk_tpvs_states1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tpvs_tpv_types1`
    FOREIGN KEY (`id_tpv_component`)
    REFERENCES `grupo_tdm_db`.`tpv_types` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tpvs_users2`
    FOREIGN KEY (`id_user`)
    REFERENCES `grupo_tdm_db`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
