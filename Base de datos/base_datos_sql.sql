...
CREATE TABLE IF NOT EXISTS `grupo_tdm_db`.`ip_linux_directions` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `ip` VARCHAR(12) NULL,
  `id_serve` INT NOT NULL,
  `id_state` INT NOT NULL,
  `updated_at` TIMESTAMP NULL,
  `created_at` TIMESTAMP NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_ip_linux_directions_services1_idx` (`id_serve` ASC),
  INDEX `fk_ip_linux_directions_states1_idx` (`id_state` ASC),
  CONSTRAINT `fk_ip_linux_directions_services1`
    FOREIGN KEY (`id_serve`)
...
CREATE TABLE IF NOT EXISTS `grupo_tdm_db`.`server_sql_licenses` (
  ...
  `created_at` TIMESTAMP NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_server_sql_licenses_servers1_idx` (`id_serve` ASC),
...
-- -----------------------------------------------------
-- Table `grupo_tdm_db`.`vpn_serves`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `grupo_tdm_db`.`vpn_serves` (
  `id` INT NOT NULL AUTO_INCREMENT,
