...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-02-2024 a las 18:14:42
...
INSERT INTO `payment_methods` (`id`, `name`, `updated_at`, `created_at`) VALUES
...
INSERT INTO `spreadsheets` (`id`, `date`, `id_state`, `updated_at`, `created_at`) VALUES
(1, '2024-02-09', 1, '2024-02-10 21:53:23', '2024-02-10 21:53:23');
...
(1, 1, 1, '40000', NULL, '2024-02-10 21:53:23', '2024-02-10 21:53:23'),
(2, 2, 1, '80000', NULL, '2024-02-10 21:53:23', '2024-02-10 21:53:23'),
(3, 1, 2, '30000', NULL, '2024-02-10 21:53:23', '2024-02-10 21:53:23'),
(4, 2, 2, '70000', NULL, '2024-02-10 21:53:23', '2024-02-10 21:53:23');
...
(1, '120000', '0', '0', 1, 1, 3, '2024-02-10 21:53:23', '2024-02-10 21:53:23'),
(2, '100000', '0', '0', 2, 1, 3, '2024-02-10 21:53:23', '2024-02-10 21:53:23');
...
(60, 'AYUDA CON COSAS', 'N/A', NULL, '08/02/2024 12:18:43', '08/02/2024 14:18:43', 4, 10, 1, 3, '2024-02-08 17:19:06', '2024-02-08 17:19:06'),
(61, 'asd', 'adasd', NULL, '08/02/2024 12:19:50', '08/02/2024 13:19:50', 5, 10, 10, 2, '2024-02-08 17:20:16', '2024-02-08 17:19:59'),
(62, 'asda', 'asdsad', NULL, '08/02/2024 12:20:26', '08/02/2024 13:20:26', 5, 10, 1, 3, '2024-02-08 17:20:34', '2024-02-08 17:20:34');
...
INSERT INTO `tpvs` (`id`, `tpv`, `id_user`, `id_company`, `id_tpv_component`, `id_state`, `updated_at`, `created_at`) VALUES
(1, 'TPV00101', NULL, 1, 1, 1, NULL, NULL),
(2, 'TPV00102', NULL, 2, 1, 1, NULL, NULL);
...
--
ALTER TABLE `servers`
  ADD CONSTRAINT `fk_servers_states1` FOREIGN KEY (`id_state`) REFERENCES `states` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `server_sql_licenses`
--
ALTER TABLE `server_sql_licenses`
  ADD CONSTRAINT `fk_server_sql_licenses_servers1` FOREIGN KEY (`id_server`) REFERENCES `servers` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_server_sql_licenses_sql_licenses1` FOREIGN KEY (`id_sql_licenses`) REFERENCES `sql_licenses` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_server_sql_licenses_states1` FOREIGN KEY (`id_state`) REFERENCES `states` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Filtros para la tabla `sql_licenses`
--
ALTER TABLE `sql_licenses`
  ADD CONSTRAINT `fk_sql_licenses_states1` FOREIGN KEY (`id_state`) REFERENCES `states` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `tpvs`
  ADD CONSTRAINT `fk_tpvs_companies1` FOREIGN KEY (`id_company`) REFERENCES `companies` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  ADD CONSTRAINT `fk_tpvs_users1` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Filtros para la tabla `vpns`
--
ALTER TABLE `vpns`
  ADD CONSTRAINT `fk_vpns_states1` FOREIGN KEY (`id_state`) REFERENCES `states` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_vpns_users1` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `vpn_servers`
--
ALTER TABLE `vpn_servers`
  ADD CONSTRAINT `fk_vpn_serves_ip_linux_directions1` FOREIGN KEY (`id_ip_linux_direction`) REFERENCES `ip_linux_directions` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_vpn_serves_states1` FOREIGN KEY (`id_state`) REFERENCES `states` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_vpn_serves_vpns1` FOREIGN KEY (`id_vpn`) REFERENCES `vpns` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `wifi_channels`
--
ALTER TABLE `wifi_channels`
  ADD CONSTRAINT `fk_wifi_channels_states1` FOREIGN KEY (`id_state`) REFERENCES `states` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
